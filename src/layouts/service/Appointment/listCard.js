...
function CenteredBlogCard({ workplace, color }) {
  ...
  const submit = async () => {
    ...
    service.spId = workplace.spId._id;
                      ...
                      attachments: [
                        {
                          type: "image",
                          asset_url:
                            "https://medaidserver.herokuapp.com" + attachments,
                          thumb_url:
                            "https://medaidserver.herokuapp.com" + attachments,
                        },
                      ],
        ...
        <Grid item xs={12} md={8} lg={8}>
          <SuiBox px={2} mt={-1} textAlign="left">
            ...
            <SuiTypography
              ...
              style={{ fontSize: "0.8rem" }}
            >
              {workplace.fees ? <>Fees : {workplace.fees}&nbsp;₨</> : <></>}
            </SuiTypography>
          </SuiBox>
        </Grid>
        ...
        <Slide direction="down" in={show} timeout={500}>
          ...
          >
            <SuiBox
              ...
              p={2}
            >
              <SuiTypography variant="h5">Book Appointment</SuiTypography>
              <CloseIcon
                fontSize="medium"
                sx={{ cursor: "pointer" }}
                onClick={toggleModal}
